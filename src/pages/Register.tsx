...
return (
  <div className="min-h-screen bg-slate-100 flex items-center justify-center px-4 sm:px-6 py-10">
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8 sm:mb-10">
        ...
        <p className="text-sm text-slate-500 mt-3">
          Create your SecureCase account
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-slate-300 rounded-xl px-4 py-3 text-slate-900 bg-white focus:outline-none focus:ring-2 focus:ring-slate-400 focus:border-slate-400 transition"
            />
          </div>
